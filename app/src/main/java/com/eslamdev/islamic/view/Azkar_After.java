...
import com.eslamdev.islamic.databinding.ActivityAzkarAfterBinding;
...
public class Azkar_After extends AppCompatActivity {
    ...
    private ActivityAzkarAfterBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAzkarAfterBinding.inflate(getLayoutInflater());
        ...
        try {
            JSONObject jsonObject = new JSONObject(JsonDataFromAsset("Azkar After-prayer.json"));
            ...
            Log.e("Azkar_After", "JSON Parsing Error: " + e.getMessage(), e);
            e.printStackTrace();
        }
